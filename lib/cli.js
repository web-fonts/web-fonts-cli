...
module.exports.run = function() {
    ...
    program
        ...
        .option('-r, --release [release]', 'Font release. Default: 1.0.0', fn, '1.0.0')
        .option('-g, --git [git]', 'Initialise with Github. Default: false', fn, false)
        .option('-u, --username [username]', 'Github username. Default: Landish', fn, 'Landish')
